...
const products: IProductInput[] = [
  ...
  {
    name: "Arsenal Jersey",
    slug: toSlug("Arsenal Jersey"),
    category: "Jersey",
    images: ['/images/arsenal.png'],
    tags: ["new-arrival"],
    isPublished: true,
    price: 50.0,
    listPrice: 80.5,
  ...
  },
  {
    ...
    slug: toSlug("Arsenal Away Jersey"),
    category: "Jersey",
    images: ["/images/arsenal1.png"],
    tags: ["featured"],
    isPublished: true,
    price: 55.0,
    listPrice: 85.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Arsenal away kit for the season.",
    sizes: ["S", "M", "L", "XL"],
    colors: ["White", "Blue"],
    reviews: [],
  },
  {
    ...
    slug: toSlug("Barcelona Jersey"),
    category: "Jersey",
    images: ["/images/bar.jpeg"],
    tags: ["best-seller"],
    isPublished: true,
    price: 60.0,
    listPrice: 90.0,
  ...
  },
  {
    ...
    numSales: 0,
    countInStock: 10,
    description: "Messi signature jersey.",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Blue", "Red"],
    reviews: [],
  },
  {
    ...
    slug: toSlug("Goalkeeper Jersey"),
    category: "Jersey",
    images: ["/images/keeper.jpeg"],
    tags: ["featured"],
    isPublished: true,
    price: 45.0,
    listPrice: 70.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Goalkeeper jersey with padded protection.",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Green", "Yellow"],
    reviews: [],
  },
  {
    ...
    slug: toSlug("Real Madrid Jersey"),
    category: "Jersey",
    images: ["/images/real.jpeg"],
    tags: ["new-arrival"],
    isPublished: true,
    price: 60.0,
    listPrice: 90.0,
    ...
    {
    name: "Aabhash Pokharel",
    slug: toSlug("Aabhask Ko WorldCup ko Jersey"),
    category: "Jersey",
  ...
  },
  {
    ...
    slug: toSlug("Real Madrid Away Jersey"),
    category: "Jersey",
    images: ["/images/real1.jpeg"],
    tags: ["featured"],
    isPublished: true,
    price: 62.0,
    listPrice: 92.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Real Madrid away kit.",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Blue"],
    reviews: [],
  },
  {
    ...
    slug: toSlug("Bayern Munich Jersey"),
    category: "Jersey",
    images: ["/images/bayern.jpeg"],
    tags: ["best-seller"],
    isPublished: true,
    price: 58.0,
    listPrice: 88.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Bayern Munich home jersey.",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Red", "White"],
    reviews: [],
  },
  {
    ...
    slug: toSlug("Bayern Munich Away Jersey"),
    category: "Jersey",
    images: ["/images/bayern1.jpeg"],
    tags: ["featured"],
    isPublished: true,
    price: 60.0,
    listPrice: 90.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Bayern Munich away kit.",
    sizes: ["S", "M", "L", "XL"],
    colors: ["White", "Red"],
    reviews: [],
  },
  {
    ...
    slug: toSlug("Manchester City Jersey"),
    category: "Jersey",
    images: ["/images/city.jpeg"],
    tags: ["new-arrival"],
    isPublished: true,
    price: 59.0,
    listPrice: 89.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Manchester City home jersey.",
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    slug: toSlug("Manchester City Away Jersey"),
    category: "Jersey",
    images: ["/images/city1.jpeg"],
    tags: ["featured"],
    isPublished: true,
    price: 61.0,
    listPrice: 91.0,
  ...
  },
  {
    ...
    slug: toSlug("Manchester United Jersey"),
    category: "Jersey",
    images: ["/images/man.jpeg"],
    tags: ["best-seller"],
    isPublished: true,
    price: 60.0,
    listPrice: 90.0,
  ...
  },
  {
    ...
    slug: toSlug("Manchester Blue"),
    category: "Jersey",
    images: ["/images/man1.jpeg"],
    tags: ["todays-deal"],
    isPublished: true,
    price: 25.0,
    listPrice: 40.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Manchester fan jersey.",
    sizes: ["S", "M", "L"],
    colors: ["Blue", "White"],
    reviews: [],
  },
  {
    name: "Real Madrid MatchBall",
    slug: toSlug("Real Madrid MatchBall"),
    category: "Ball",
    ...
    numSales: 0,
    countInStock: 10,
    description: "Official Real Madrid match ball.",
    sizes: [],
    colors: ["White"],
    reviews: [],
  },
  {
    ...
    numSales: 0,
    countInStock: 10,
    description: "Official Chelsea football.",
    sizes: [],
    colors: ["Blue"],
    reviews: [],
  },
  {
    ...
    numSales: 0,
    countInStock: 10,
    description: "Bayern official football.",
    sizes: [],
    colors: ["Red", "White"],
    reviews: [],
  },
  {
    ...
    numSales: 0,
    countInStock: 10,
    description: "Street football for casual play.",
    sizes: [],
    colors: ["White", "Black"],
    reviews: [],
  },
  {
    ...
    numSales: 0,
    countInStock: 10,
    description: "Football boots for training.",
    sizes: ["8", "9", "10", "11"],
  ...
  },
  {
    ...
    slug: toSlug("Pro Football Boots"),
    category: "Boot",
    images: ["/images/boot.jpeg"],
    tags: ["featured"],
    isPublished: true,
    price: 75.0,
    listPrice: 120.0,
  ...
  },
  {
    ...
    slug: toSlug("Speed Football Boots"),
    category: "Boot",
    images: ["/images/boot1.jpeg"],
    tags: ["best-seller"],
    isPublished: true,
    price: 80.0,
    listPrice: 130.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Speed boots for quick gameplay.",
    sizes: ["8", "9", "10", "11"],
    colors: ["Red", "White"],
    reviews: [],
  },
  {
    name: "Classic Football Boots",
    slug: toSlug("Classic Football Boots"),
    category: "Boot",
    images: ["/images/boot2.jpeg"],
    tags: ["todays-deal"],
    isPublished: true,
    price: 65.0,
    listPrice: 100.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Classic design football boots.",
    sizes: ["8", "9", "10", "11"],
    colors: ["Black", "White"],
    reviews: [],
  },
  {
    ...
    slug: toSlug("Elite Football Boots"),
    category: "Boot",
    images: ["/images/boot3.jpeg"],
    tags: ["new-arrival"],
    isPublished: true,
    price: 90.0,
    listPrice: 150.0,
    ...
    numSales: 0,
    countInStock: 10,
    description: "Elite football boots for pro players.",
    sizes: ["8", "9", "10", "11"],
    colors: ["Black", "Gold"],
    reviews: [],
  },
  ...
  webPages: [
    {
      title: 'About Us',
      slug: 'about-us',
      content: `Welcome to Aabhash ko Sasta Pasal, your trusted destination for quality products and exceptional service. Our journey began with a mission to bring you the best shopping experience by offering a wide range of products at competitive prices, all in one convenient platform.

At Aabhash ko Sasta Pasal, we prioritize customer satisfaction and innovation. Our team works tirelessly to curate a diverse selection of items, from everyday essentials to exclusive deals, ensuring there's something for everyone. We also strive to make your shopping experience seamless with fast shipping, secure payments, and excellent customer support.

As we continue to grow, our commitment to quality and service remains unwavering. Thank you for choosing Aabhash ko Sasta Pasal—we look forward to being a part of your journey and delivering value every step of the way.`,
      isPublished: true,
    },
    {
      title: 'Contact Us',
...
- **Address:** 4,imadol,Lalitpur ,Ikku ko Ghar ko tala 
- **Phone:** +977 9840668297
...
`,
    ...
    },
    {
      ...
      content: `At Aabhash ko Sasta Pasal, our customer service team is here to ensure you have the best shopping experience. Whether you need assistance with orders, product details, or returns, we are committed to providing prompt and helpful support.
